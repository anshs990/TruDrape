...
function App() {
  ...
  return (
    ...
    >
      ...
      >
        <h2 style={{ color: "#4CAF50", letterSpacing: "2px" }}>
          TRUDRAPE
        </h2>
        <p style={{ color: "#666", fontSize: "11px" }}>
          AI-DRIVEN MEASUREMENT SYSTEM
        </p>
        ...
        <div style={{ display: "flex", gap: "10px", marginBottom: "25px" }}>
          <button
            ...
            style={{
              flex: 1,
              padding: "10px",
              background: gender === "male" ? "#4CAF50" : "#222",
              color: "white",
              border: "none",
            }}
          >
          ...
          <button
            ...
            style={{
              flex: 1,
              padding: "10px",
              background: gender === "female" ? "#4CAF50" : "#222",
              color: "white",
              border: "none",
            }}
          >
        ...
        <Canvas camera={{ position: [0, 0, 5], fov: 40 }}>
          <Suspense fallback={<Loader />}>
            <Stage environment="city" intensity={0.5} center>
              ...
              <Text position={[0.9, topY, 0]} fontSize={0.12} color="#4CAF50">
                {measurements.height}cm
              </Text>
            </Stage>
          </Suspense>
